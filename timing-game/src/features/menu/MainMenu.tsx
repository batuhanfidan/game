    ...
    <div className="min-h-screen w-screen bg-[#0f0f11] text-white font-mono flex flex-col items-center py-12 px-4 relative overflow-hidden selection:bg-cyan-500/30">
      ...
      {isAdmin && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 bg-red-600 hover:bg-red-500 text-white p-3 rounded-full shadow-2xl shadow-red-500/50 transition-all hover:scale-110"
          title="Admin Paneli"
        >
          <ShieldAlert size={24} />
        </button>
